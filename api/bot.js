...
bot.command('start', (ctx) => {
	return ctx.reply(
		"Правило первое: ты не говоришь о боте. \nПравило второе: ТЫ НЕ ГОВОРИШЬ О БОТЕ. \nЛадно, шучу. Это просто бот для статистики. Но ты же знаешь, что все не так просто, да?\nСкоро."
	);
});
